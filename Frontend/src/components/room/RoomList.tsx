        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex space-x-2">
            <button
              onClick={fetchRooms}
              disabled={loading}
              className="bg-blue-100 text-blue-700 px-3 py-2 rounded-md hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
            >
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {rooms.map((room) => (
                  <tr key={room.roomId} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{room.hostNickname || room.hostUsername}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
